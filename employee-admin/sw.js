const CACHE_NAME = 'employee-admin-v20';
const APP_SHELL = [
  ...
  '/employee-admin/js/min/attendance.js?v=20260618-3',
  '/employee-admin/js/min/salary.js?v=20260615-1',
  '/employee-admin/js/min/reports.js?v=20260615-1',
  '/employee-admin/js/min/main.js?v=20260618-1',
  '/employee-admin/js/min/staff.js?v=20260618-2',
