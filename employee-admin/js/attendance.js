                ...
                <tr class="attendance-row">
                    <td onclick="switchView('staff-profile', '${s.id}')" style="cursor:pointer; font-weight:700; color:var(--primary);">
                        <div style="display:flex; align-items:center; gap:10px;" class="staff-link">
                            <img onload="window.PhotoHelper.smartPhoto(this, '${s.photo || ''}', '${encodeURIComponent(s.name)}', 'random', 'fff', 30)" style="width:30px; height:30px; border-radius:8px; object-fit:cover;" alt="${s.name} profile photo">
                            <div>
